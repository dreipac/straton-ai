import { applyAccentPalette, DEFAULT_ACCENT_PALETTE_ID } from './accentPalettes'
...
export function defaultUiSettings(): UiSettingsV1 {
  return {
    /* Standard fuer neue Nutzer: Hell + Blau (DEFAULT_ACCENT_PALETTE_ID ist bereits 'solid-blue'). */
    theme: 'light',
    sidebarScale: '75',
