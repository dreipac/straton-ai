    ...
    <section className="account-settings-panel">
      <div className="account-settings-profile-layout">
        <div className="account-settings-avatar-column">
          {/* Der Ändern-Knopf sitzt auf dem Bild, deshalb umschliesst der Rahmen beide. */}
          <div className="account-settings-avatar-frame">
            ...
            <SecondaryButton
              type="button"
              className="account-settings-avatar-edit-btn"
              disabled={disableAvatarActions || isAvatarBusy}
              aria-label={isAvatarBusy ? 'Profilbild wird hochgeladen' : 'Profilbild ändern'}
              title={isAvatarBusy ? 'Profilbild wird hochgeladen' : 'Profilbild ändern'}
              onClick={() => {
                avatarInputRef.current?.click()
              }}
            >
              <img className="ui-icon" src={editIcon} alt="" aria-hidden="true" />
            </SecondaryButton>
          </div>
