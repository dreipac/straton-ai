...
export const SUBSTEP_FLOW_RULES = [
  ...
  'Fragetypen passend zum Inhalt wählen: mcq, true_false, text (Freitext) ODER match/categorize — dieselben Typen wie bei Kapiteln und Lernblatt, kein reduziertes Set.',
  'match (Begriffe/Elemente einander zuordnen, z. B. Begriff ↔ Definition, Konto ↔ Kontoart, Regel ↔ Beispiel): PFLICHT statt einer text- oder mcq-Frage, sobald die Aufgabe im Kern eine Zuordnung mehrerer Paare ist. NICHT als Fließtext-Aufzählung formulieren, die der Lernende von Hand eintippen müsste — das ist eine interaktive Zuordnungsaufgabe (Drag-and-Drop in der Oberfläche), kein Freitext. Felder "matchLeft"/"matchRight" gleich lang (mindestens 2 Paare), expectedAnswer = Index-Paare wie "0,1".',
  'categorize (Begriffe in 2–4 Kategorien einsortieren): analog PFLICHT statt einer mcq mit künstlich kombinierten Paar-Optionen. Felder "categories" (2–4) und "items" (3–8), expectedAnswer = Kategorie-Index je Begriff, komma-getrennt.',
