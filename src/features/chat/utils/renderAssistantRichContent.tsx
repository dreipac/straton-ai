...
import { ChatTableCopyButton } from '../components/chat-window/ChatTableCopyButton'
...
function renderBlock(
  ...
  switch (block.type) {
    ...
    case 'table': {
      ...
      return (
        <div key={key} className="chat-md-table-block">
          ...
          <ChatTableCopyButton rows={block.rows} />
        </div>
      )
    }
    case 'cards':
