...
export function useChatPageModals({
  ...
  /**
   * Nur noch für den kompakten Mobile-Sheet-Pfad (ProfileFullSheet) — die Desktop-Ansicht läuft
   * seit dem Umbau URL-gesteuert direkt im rechten Chat-Hauptbereich (`.chat-main.is-settings-active`,
   * siehe `openSettingsWorkspace` in ChatPage.tsx), nicht mehr als Modal.
   */
  const openSettingsModal = useCallback(
    ...
    [refreshProfile, setIsMobileSidebarOpen],
  )
