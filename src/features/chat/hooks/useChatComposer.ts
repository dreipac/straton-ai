...
import { clearChatPrefill, readChatPrefill } from '../services/chatPrefill'
...
export function useChatComposer({
  ...
  /*
   * Vorbereitete Frage aus dem Lernpfad („Im Chat dazu fragen", UI-Spezifikation 3.6).
   *
   * Gelesen im Initialisierer, geloescht im Effekt darunter: Lesen ist nebenwirkungsfrei und darf
   * deshalb auch bei doppeltem Aufbau zweimal passieren, das Loeschen laeuft genau einmal.
   */
  const [draft, setDraft] = useState(() => readChatPrefill())
