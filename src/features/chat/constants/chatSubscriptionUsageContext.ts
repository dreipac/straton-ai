...
export function getChatSubscriptionUsageInstruction(
  ...
  cachedInstruction = [
    ...
    data,
    '- Bei Fragen zu Verbrauch, Limits, Guthaben, «was kann ich noch nutzen», «wie viel habe ich verbraucht», Abo-Kontingent, KI-Credits, Bilder, Websuche, Dateien: kurze Einleitung (1–2 Sätze), dann genau eine eigene Zeile nur mit [[STRATON_SUBSCRIPTION_USAGE]] — die App zeigt darunter dieselben Karten wie in den Einstellungen.',
