...
export function getStratonPlatformGuideInstruction(): string {
  return [
    ...
    '- **Allgemein:** App-Sprache; Auto-Löschen leerer Chats/Lernpfade.',
    '- **Einladungen:** Geteilte Chats — Einladungen verwalten.',
    '- **Archiv:** Archivierte Chats wiederherstellen oder löschen.',
    '- **Personalisieren:** Theme (White/Dark/Pink Glass/Black); Sidebar-Skalierung; Akzentfarbe; Kompaktes Eingabefeld.',
