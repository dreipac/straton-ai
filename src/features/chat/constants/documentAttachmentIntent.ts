...
const EXPLICIT_SUMMARY_REQUEST_RE =
  /\b(fasse\s+zusammen|zusammenfassung|zusammenfassen|überblick|ueberblick|stichwortartig|in\s+kapiteln|hauptpunkte\s+im\s+überblick|ausführliche?\s+zusammenfassung|zusammenfass(?:e|en)\s+(?:mir|bitte|das|den|die|zu|von))\b/i
