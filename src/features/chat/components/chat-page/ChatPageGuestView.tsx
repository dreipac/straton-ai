...
import type { ChatComposerSelection } from '../../constants/chatComposerSelection'
...
type ChatPageGuestViewProps = {
  ...
  guestComposerSelection: ChatComposerSelection
  ...
  onGuestComposerSelection: (selection: ChatComposerSelection) => void
    ...
    >
      ...
      <section className={`chat-main chat-main-guest${isChatToolbarMobile ? ' chat-main--share-toolbar' : ''}`}>
        ...
        <div className="guest-chat-panel">
          ...
          {/* Gäste sehen den Modell-Picker nicht und senden nichts — die Websuche steht deshalb
              fest auf dem Standard, es gibt hier nichts einzustellen. */}
          <ChatWindow
            threadKey={null}
            messages={[]}
            isSending={false}
