...
export type ChatMessageListProps = {
  ...
  /** Wie `onCopyUserMessage`, aber inkl. HTML (Tabellen/Listen kommen in Word/Outlook korrekt an). */
  onCopyAssistantMessage: (text: string) => boolean | Promise<boolean>
              ...
              >
                    ...
                    {savedDocuments.length > 0 ? (
                      ...
                      >
                        {savedDocuments.map((attachment) => {
                          ...
                          const { base: attachmentBaseName, ext: attachmentExt } = splitFileNameForDisplay(
                            attachment.name,
                          )
                          const chipContent = (
                            <>
                              ...
                              <span className="chat-attachment-chip-text">
                                <span className="chat-attachment-chip-name">{attachmentBaseName}</span>
                                {attachmentExt ? (
                                  <span className="chat-attachment-chip-ext">{attachmentExt}</span>
                                ) : null}
                              </span>
                            </>
                          )
                ...
                {userMessageShowBubble ? (
                  <div
                    ...
                    className={`chat-message is-user chat-user-message-bubble squircle${
                ...
                <div className="chat-message-actions">
                  {showAssistantCopyButton ? (
                    <ChatAssistantMessageCopyButton
                      onCopy={() => onCopyAssistantMessage(assistantCopyText)}
                    />
                  ) : null}
