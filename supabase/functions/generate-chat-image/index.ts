...
// Preistabelle liegt zentral in der DB (`public.ai_model_pricing`), nicht mehr hier hart codiert
// (war zuvor eine dritte, unabhängige Kopie derselben Zahlen, siehe credits-system-plan.md 2.6).
...
async function logAiTokenUsage(
  ...
  if (costErr) {
    console.error('[generate-chat-image] estimate_ai_cost_usd failed', costErr.message)
  }
