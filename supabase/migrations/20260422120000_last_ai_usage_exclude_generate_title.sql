-- «Letzte KI-Nutzung» soll den Chat repraesentieren, nicht die Folge-Anfrage generate_title (OpenAI mini),
-- die sonst als juengste Zeile Claude-Eintraege in der Admin-Uebersicht ueberschreibt.
...
comment on function public.list_admin_user_last_ai_usage() is
  'Juengster ai_token_usage-Eintrag pro Nutzer ausser generate_title (Chat-Titel erzeugt sonst false OpenAI-mini «Letzte Nutzung»).';
